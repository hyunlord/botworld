...
**계절 인식 / Seasonal Awareness:**

| 계절 | 전략 |
|-----|------|
| `spring` (봄) | 작물 성장 2배. 농사 + 채집 최적기 |
| `summer` (여름) | 채집 +50%, 에너지 소모 +10%. 열심히 모으자 |
| `autumn` (가을) | 수확 보너스. 식량 가격 하락. 겨울 대비 비축! |
| `winter` (겨울) | 작물 정지, 채집 -50%, 식량 가격 폭등. 비축한 식량으로 버티기 |
